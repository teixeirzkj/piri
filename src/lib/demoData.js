...
export const DEMO_PRODUCTS = [
  ...
  { id: 'beb-coca-lata', cat: 'bebidas', name: 'Coca-Cola Lata 350ml', description: 'Bem geladinha.', long: 'Coca-Cola gelada, lata de 350ml.', price: 6, cost: 3, stock: 48, icon: true, iconKind: 'lata', iconColor: '#C1121F', active: true },
  { id: 'beb-guarana-lata', cat: 'bebidas', name: 'Guaraná Antarctica Lata 350ml', description: 'Bem geladinha.', long: 'Guaraná Antarctica gelado, lata de 350ml.', price: 6, cost: 3, stock: 48, icon: true, iconKind: 'lata', iconColor: '#1f8a3b', active: true },
  { id: 'beb-sukita-lata', cat: 'bebidas', name: 'Sukita Laranja Lata 350ml', description: 'Bem geladinha.', long: 'Sukita sabor laranja, lata de 350ml.', price: 6, cost: 3, stock: 48, icon: true, iconKind: 'lata', iconColor: '#FF8A00', active: true },
  { id: 'beb-sprite-lata', cat: 'bebidas', name: 'Sprite Lata 350ml', description: 'Bem geladinha.', long: 'Sprite gelado, lata de 350ml.', price: 6, cost: 3, stock: 48, icon: true, iconKind: 'lata', iconColor: '#2E9E4F', active: true },
  { id: 'beb-coca-1l', cat: 'bebidas', name: 'Coca-Cola 1 Litro', description: 'Garrafa de 1 litro.', long: 'Coca-Cola, garrafa de 1 litro.', price: 8, cost: 4, stock: 24, icon: true, iconKind: 'garrafa', iconColor: '#C1121F', active: true },
  { id: 'beb-guarana-1l', cat: 'bebidas', name: 'Guaraná Antarctica 1 Litro', description: 'Garrafa de 1 litro.', long: 'Guaraná Antarctica, garrafa de 1 litro.', price: 8, cost: 4, stock: 24, icon: true, iconKind: 'garrafa', iconColor: '#1f8a3b', active: true },
  { id: 'beb-sukita-1l', cat: 'bebidas', name: 'Sukita Laranja 1 Litro', description: 'Garrafa de 1 litro.', long: 'Sukita sabor laranja, garrafa de 1 litro.', price: 8, cost: 4, stock: 24, icon: true, iconKind: 'garrafa', iconColor: '#FF8A00', active: true },
