...
export const DEMO_PRODUCTS = [
  ...
  { id: 'g-esfiha-carne', cat: 'grandes', name: 'Esfiha de Carne', desc: 'Recheio de carne moída bem temperada.', long: 'Esfiha assada no forno, recheio farto de carne moída bem temperada.', price: 1, cost: 0.4, stock: 40, img: '/products/forno-esfiha-carne.jpeg', active: true },
  { id: 'g-esfiha-frango', cat: 'grandes', name: 'Esfiha de Frango c/ Requeijão', desc: 'Frango desfiado com requeijão cremoso.', long: 'Esfiha assada no forno, recheio de frango desfiado com requeijão cremoso.', price: 1, cost: 0.4, stock: 40, img: '/products/forno-esfiha-frango.jpeg', active: true },
  { id: 'g-esfiha-calabresa', cat: 'grandes', name: 'Esfiha de Calabresa c/ Requeijão', desc: 'Calabresa moída com requeijão cremoso.', long: 'Esfiha assada no forno, recheio de calabresa moída com requeijão cremoso.', price: 1, cost: 0.4, stock: 40, img: '/products/forno-esfiha-calabresa.jpeg', active: true },
  { id: 'g-bauru', cat: 'grandes', name: 'Baurú', desc: 'Pão fofinho recheado, assado no forno.', long: 'Baurú assado no forno, pão fofinho e recheio generoso.', price: 1, cost: 0.4, stock: 40, img: '/products/forno-bauru.jpeg', active: true },
  { id: 'g-hamburgao', cat: 'grandes', name: 'Hambúrgão c/ Cheddar', desc: 'Pão recheado com cheddar derretido.', long: 'Hambúrgão assado no forno, recheado com cheddar derretido.', price: 1, cost: 0.4, stock: 40, img: '/products/forno-hamburgao-cheddar.jpeg', active: true },
  { id: 'g-doguinho', cat: 'grandes', name: 'Doguinho c/ Requeijão', desc: 'Pãozinho macio com salsicha e requeijão.', long: 'Doguinho assado no forno, pãozinho macio com salsicha e requeijão cremoso.', price: 1, cost: 0.4, stock: 40, img: '/products/forno-doguinho.jpeg', active: true },
